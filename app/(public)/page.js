  ...
  return (
    <div className="bg-gray-950 text-gray-100">
      ...
      <section className="relative overflow-hidden py-24 px-4 text-center">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_800px_500px_at_50%_-100px,rgba(251,191,36,0.12),transparent)] pointer-events-none" />
      ...
      <section className="border-y border-gray-800 py-12 px-4">
        <div className="max-w-4xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={s.label}>
              <div className="text-3xl font-bold text-amber-400 font-mono">{s.num}</div>
      ...
      <section className="py-20 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: '👤', title: 'অ্যাকাউন্ট তৈরি করুন', desc: 'ইমেইল বা Google দিয়ে সাইন আপ করুন এবং আপনার প্রোফাইল সাজান।' },
              { icon: '🔗', title: 'লিংক শেয়ার করুন', desc: 'আপনার ইউনিক প্রোফাইল লিংক সোশ্যাল মিডিয়ায় শেয়ার করুন।' },
      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-2xl mx-auto bg-linear-to-r from-amber-400/10 to-amber-600/10 border border-amber-400/20 rounded-3xl p-12">
          <h2 className="text-3xl font-bold mb-4">আজই শুরু করুন</h2>
          <p className="text-gray-400 mb-8">বিনামূল্যে অ্যাকাউন্ট তৈরি করুন এবং আপনার ক্রিয়েটর জার্নি শুরু করুন।</p>
          <Link href="/signup" className="bg-amber-400 hover:bg-amber-500 text-gray-900 font-bold text-lg px-10 py-4 rounded-xl transition inline-block">
