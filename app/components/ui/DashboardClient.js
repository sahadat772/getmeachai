  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 mb-8">
        <h2 className="text-base font-semibold mb-6">মাসিক আয় (৳)</h2>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
        <h2 className="text-base font-semibold mb-5">সাম্প্রতিক সাপোর্ট</h2>
        {transactions.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {transactions.map((t) => (
              ...
              >
                <div
                  className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg flex-shrink-0 ${t.method === "bKash" ? "bg-pink-900/30" : "bg-orange-900/30"}`}
                >
                  {t.method === "bKash" ? "📱" : "💳"}
                </div>
